...
public class InstallService {
    ...
    public void dbInstall() {
        ...
        try(Connection conn = DriverManager.getConnection("jdbc:sqlite:"+path+"?"+decryptor(getDbValue()))) {
            ...
            stmt.execute("CREATE TABLE SETTINGS (TYPE TEXT, EXTERNAL_URL TEXT, USE_TRASH TEXT, TRASH_PATH TEXT, ALLOW_JOIN TEXT, META_TITLE TEXT, META_AUTHOR TEXT, META_DESCRIPTION TEXT, META_KEYWORDS TEXT" +
                            ", PRIMARY KEY(TYPE))");
            ...
            stmt.execute("INSERT INTO SETTINGS (TYPE, EXTERNAL_URL, USE_TRASH, TRASH_PATH, ALLOW_JOIN, META_TITLE, META_AUTHOR, META_DESCRIPTION, META_KEYWORDS) " +
                            "VALUES('default', 'http://127.0.0.1:11024', 'N', '', 'N', 'Every Cloud', 'EveryCloud', 'EveryCloud Share personal cloud for everyone.', 'EveryCloud, Share, Personal, Cloud')");
